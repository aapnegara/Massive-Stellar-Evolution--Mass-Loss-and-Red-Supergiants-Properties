...
v_rot_ZAMS_array=(350 320 310 300 280) #346 314 305 295 275
ZFN_array=("'z0014_y0266_ekstrom_60.data'" "'z0014_y0266_ekstrom_40.data'" "'z0014_y0266_ekstrom_32.data'" "'z0014_y0266_ekstrom_25.data'" "'z0014_y0266_ekstrom_20.data'")
M_ZAMS_array=(60 40 32 25 20)

for vc in 1e-4; do
for dq in 0.0005 0.0001; do
